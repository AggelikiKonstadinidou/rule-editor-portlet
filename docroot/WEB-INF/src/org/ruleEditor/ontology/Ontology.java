...
public class Ontology implements Serializable {
	...
	public List<ArrayList<OntologyClass>> getClassesStructured() {
		...
		for(String s : classes){
			...
			//set object and data properties
			on.setDataProperties(setDataPropertiesToClass(vClasse));
			on.setObjectProperties(setObjectPropertiesToClass(vClasse));
	...
	public List<String> setDataPropertiesToClass(String name) {
		List<String> solutions = Arrays.asList("name",
				"Id", "description");
		...
		List<String> setting = Arrays.asList("name", "id",
				"description","refersTo","value");
		List<String> inferredConfiguration = Arrays.asList("id", "name");
		List<String> configuration = Arrays.asList("id", "name", "isActive","solutionIsPreferred");
	...
	public List<String> setObjectPropertiesToClass(String name){
		List<String> solutions = Arrays.asList("refersTo",
				"InstalledSolution", "Preference", "Metadata", "Setting",
				"InferredConfiguration", "Configuration", "Conflict",
				"ConflictResolution", "PreferenceSet", "OperatingSystem",
				"MultipleATConflict", "MultipleSolutionConflict",
				"Environment", "Devices", "Platforms");
